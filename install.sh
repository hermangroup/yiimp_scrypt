...
# Fork Author: TheWillyCat
# Current Author: Freeman
# Web: http://pool.peopleland.net/
# Discord: Discord: https://discord.gg/2mDkbyM
# Program:
...
displayErr() {
    ...
    output " "
    read -e -p "Enter time zone (e.g. America/New_York or UTC) : " TIME
...
' | sudo -E tee /var/web/serverconfig.php >/dev/null 2>&1
    ...
    output " "
    output " "
    output "Reminders. Your mysql information is saved in ~/.my.cnf. this installer did not directly install anything required to build coins."
    output " "
